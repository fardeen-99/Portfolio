...
console.log(filteru.length)
  ...
  return (
    ...
    <section
      ...
      `}
    >
<input type="text" value={search} onChange={(e)=>setsearch(e.target.value)} placeholder='Seach apps' className='outline-0 text-lg border-0 p-1 text-white w-full' />
