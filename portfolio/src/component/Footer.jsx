  ...
  return (
    ...
    <audio src="/audio.mp4" ref={refu} loop></audio>
      <footer className='mac-dock flex gap-2  absolute bottom-5 left-[50%] transform translate-x-[-50%] px-2 sm:px-4 py-1 rounded-xl  w-[90%] overflow-x-auto sm:overflow-x-visible  no-scrollbar' >
        ...
        <img className='px-3 py-2 rounded-xl git hover:scale-[1.25] hover:-translate-y-[20%] transition-transform duration-200 icon' src="/public/icons/github.svg" alt=""
        ...
        className='px-3 py-2 rounded-xl note hover:scale-[1.25] hover:-translate-y-[20%] transition-transform duration-200 icon' src="/public/icons/note.svg" alt="" />
         <div
        
          onClick={setting}
          className="px-5 py-3 md:px-4 rounded-xl cli hover:scale-[1.25] hover:-translate-y-[20%] transition-transform duration-200 icon text-amber-50 music"
        >
...
: <FaPlay className=" text-xl font-extrabold text-blue-100" />
        ...
        className='px-3 py-2 rounded-xl cli hover:scale-[1.25] hover:-translate-y-[20%] transition-transform duration-200 icon' src="/public/icons/cli.svg" alt="" />
